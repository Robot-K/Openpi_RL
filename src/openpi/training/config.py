...
class LeRobotAirbotDataConfig(DataConfigFactory):
    ...
    # When True, randomly permutes the RGB channels of all cameras during
    # training (50% probability per sample).  Never applied at inference.
    enable_channel_permutation_aug: bool = False
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        if self.enable_channel_permutation_aug:
            repack_inputs.append(airbot_policy.AirbotChannelPermutationAugmentation(prob=0.5))
...
_CONFIGS = [
    ...
    #
    TrainConfig(
        name="pi05_airbot_clothes_folding",
        model=pi0_config.Pi0Config(
